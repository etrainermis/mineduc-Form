...
"[project]/utils/token.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/utils/session.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$token$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/token.ts [app-ssr] (ecmascript)");
;
class SessionManager {
    ...
    initialize() {
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$token$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getToken"])();
        const refreshToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$token$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getRefreshToken"])();
        if (token && (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$token$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isTokenValid"])()) {
            this.session = {
                token,
                refreshToken,
    ...
    async setSession(token, refreshToken) {
        try {
            // Store tokens
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$token$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setToken"])(token);
            if (refreshToken) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$token$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setRefreshToken"])(refreshToken);
            }
    ...
    clearSession() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$token$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["removeTokens"])();
        this.session = {
            token: null,
            refreshToken: null,
            isAuthenticated: false
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$session$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/session.ts [app-ssr] (ecmascript)");
...
function LoginPage() {
    ...
    const onSubmit = async (data)=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BACKEND_URL"]}/auth/login`, data, {
                headers: {
                    "Content-Type": "application/json",
            ...
            if (response.data && response.data.success) {
                ...
                if (access && refresh_token) {
                    ...
                    await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$session$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sessionManager"].setSession(access, refresh_token);
                    console.log("Session set:", __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$session$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sessionManager"].getSession());
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].isAxiosError(error)) {
                const errorMessage = error.response?.data?.message || error.response?.data?.error || error.response?.data?.data?.message || "Login failed. Please check your credentials and try again.";
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("An unexpected error occurred. Please try again later.");
            }
        } finally{
            setIsLoading(false);
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex min-h-screen bg-[#F9F9F9] relative",
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex flex-col items-center justify-center w-full px-8 lg:w-1/2",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                    className: "text-3xl font-medium text-gray-900 mb-1 text-center",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Fill in the form to continue"
                                }, void 0, false, {
                                    fileName: "[project]/components/auth/login-page.tsx",
                                    lineNumber: 156,
                                    columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "h-[90vh] w-[95%] relative mx-auto top-9",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                        src: "/background_v1.svg",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4fd9677a._.js.map